...
class ProductionTrainer:
    ...
    def _train_shallow_production(self, params: Dict[str, Any], model_dir: Path) -> Dict[str, Any]:
        ...
        module_path = Path(__file__).parent.parent.parent / "image-classifier-shallow"
        ...
        if script_path.exists():
            cmd = [
                ...
                "--classifier_type", params.get("classifier_type", "svm"),
            ...
            if "kernel" in params:
                cmd.extend(["--svm_kernel", params["kernel"]])
            if "n_estimators" in params:
                cmd.extend(["--rf_n_estimators", str(params["n_estimators"])])
            ...
            val_accuracy = self._extract_metrics_from_log(log_file).get("best_validation_accuracy", 0.0)
    ...
    def _train_deep_v1_production(self, params: Dict[str, Any], model_dir: Path) -> Dict[str, Any]:
        ...
        module_path = Path(__file__).parent.parent.parent / "image-classifier-deep-v1"
        ...
        with open(log_file, 'w') as f:
            process = subprocess.run(cmd, stdout=f, stderr=subprocess.STDOUT, text=True, cwd=project_root)
    ...
    def _train_deep_v2_production(self, params: Dict[str, Any], model_dir: Path) -> Dict[str, Any]:
        ...
        module_path = Path(__file__).parent.parent.parent / "image-classifier-deep-v2"
        script_path = module_path / "scripts" / "train_improved.py"
    ...
    def _train_transfer_production(self, params: Dict[str, Any], model_dir: Path) -> Dict[str, Any]:
        ...
        module_path = Path(__file__).parent.parent.parent / "image-classifier-transfer"
    ...
    def _export_to_onnx(self, model_path: Path, onnx_path: Path, params: Dict[str, Any]):
        ...
        try:
            ...
            if params["model_type"] == "transfer":
                ...
                sys.path.append(str(Path(__file__).parent.parent.parent / "image-classifier-transfer" / "src"))
                ...
                sys.path.append(str(Path(__file__).parent.parent.parent / "image-classifier-deep-v1" / "src"))
                ...
                sys.path.append(str(Path(__file__).parent.parent.parent / "image-classifier-deep-v2" / "src"))
...
def main():
    ...
    parser.add_argument('--config_dir', type=str,
                       default='/home/brandond/Projects/pvt/personal/eyeVsAI/production_training/configs',
                       help='Configuration directory')
    parser.add_argument('--models_dir', type=str,
                       default='/home/brandond/Projects/pvt/personal/eyeVsAI/production_training/models',
                       help='Models output directory')
    parser.add_argument('--logs_dir', type=str,
                       default='/home/brandond/Projects/pvt/personal/eyeVsAI/production_training/logs',
                       help='Logs directory')
